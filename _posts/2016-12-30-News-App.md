...
<p style="text-align: center;">[Direct Link](https://jordanfarrer.shinyapps.io/fake_news) || [Github](https://github.com/jrfarrer/fake_news_app)</p>
...
After typing the root password, say no by clicking any key and then **Y** to the remaining questions.
...
I will explain a few sections of the code. One of the things shiny users might have noticed as being a [non-shiny widget](http://shiny.rstudio.com/gallery/widget-gallery.html) is the [bootstrap toogles](http://www.bootstraptoggle.com/)
